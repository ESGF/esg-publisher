...
class Test1VerifyPublishSingleDatasetSingleVersion(test_0_verify_empty.Test0VerifyEmpty):
    ...
    def test_101_verify_files_on_disk_d1v1(self):
        self.tlog("Verifying files on disk: %s" % ds1)
        verify.verify_files_on_disk(ds1)

    def test_102_publish_to_db_d1v1(self):
        self.tlog("Publishing to db: %s" % ds1)
        publisher.publish_to_db(ds1)
    ...
    def test_104_publish_to_tds_d1v1(self):
        self.tlog("Publishing to TDS: %s" % ds1)
        publisher.publish_to_tds(ds1)
    ...
    def test_106_publish_to_tds_d1v1(self):
        self.tlog("Publishing to SOLR: %s" % ds1)
        publisher.publish_to_solr(ds1)
