...
setup(
    ...
    install_requires = ["psycopg2>=2.0", "SQLAlchemy>=0.5.3, <=0.7.10", "lxml>=2.0", "sqlalchemy_migrate>=0.6", "requests>=1.2.0"],
    setup_requires = ["psycopg2>=2.0", "SQLAlchemy>=0.5.3, <=0.7.10", "lxml>=2.0", "sqlalchemy_migrate>=0.6", "requests>=1.2.0"],
