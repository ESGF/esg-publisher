...
setup(
    ...
    install_requires = ["psycopg2>=2.0", "SQLAlchemy>=0.7.8,!=0.9.5,<=0.9.99", "lxml>=2.0", "sqlalchemy_migrate>=0.6", "requests>=1.2.0", "esgprep>=2.4.1"],
    setup_requires = ["psycopg2>=2.0", "SQLAlchemy>=0.7.8,!=0.9.5,<=0.9.99", "lxml>=2.0", "sqlalchemy_migrate>=0.6", "requests>=1.2.0", "esgprep>=2.4.1"],
