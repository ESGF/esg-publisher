...
class ESGUnpublishSTAC:
    ...
    def run(self, args):
        ...
        self.searchcheck = ESGSearchCheck(stac_api=stac_api, silent=silent, verbose=verbose)
    ...
    def single_unpublish(self, dset_id, pub_log):
        ...
        if do_delete:
            pub_log.info("Delete not supported for STAC catalogs. Use esgpublish to retract dataset instead")
            return(-1)
